...
insert into `ebook` (id, name, description) values (1, 'Spring Boot ', 'Java Development from beginning');
insert into `ebook` (id, name, description) values (2, 'Vue3', 'Vue from beginning');
insert into `ebook` (id, name, description) values (3, 'Python ', 'Python From beginging');
...
insert into `category` (id, parent, name, sort) values (502, 500, 'Devtools', 502);
...
delete from `doc` where id=27515918057869310;
-- 文档内容
...
create table `user` (
                        `id` bigint not null comment 'ID',
                        `account` varchar(50) not null comment '登陆名',
